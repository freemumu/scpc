...
public class HtInfoManagerAction {
	...
	public void getTableData(){
		String sql ="select id ,mc,htbh , ywlx ,htje,date_format(qssj,'%Y-%m-%d') qssj,dqjd,fkzt,jkbfb,jkje,jscb,hkzh,hkkhh,remark from scglxt_t_ht ";
...
//		String sql = "INSERT INTO SEC_USERINFO(USERISN,USERNAME,UNITISN,UNITNAME,PASSWORD,PASSWORDORG,PASSWORDNEW,POSITION,TEL,EMAIL,IPSECTION,CREATETIME)VALUES" ;
		try {
