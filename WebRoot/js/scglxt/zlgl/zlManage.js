			...
			"columnDefs": [ 
		        {
		            "render": function ( data, type, row ) {
		                ...
		                ' <a class="btn btn-pramy btn-xs" href="#" title＝"操作">合格<i class="icon-edit" onclick = "HtManage.editRow(\''+data+'\')"></i></a> '+
		                ' <a class="btn btn-success btn-xs" href="#" title＝"操作">不合格<i class="icon-edit" onclick = "HtManage.editRow(\''+data+'\')"></i></a>'+
