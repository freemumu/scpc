...
<!-- 		                            <input class='form-control' id='form_khxx_ssht' info="fromInfo" name='form_khxx_ssht'  placeholder='所属合同' type='text'> -->
		                        ...
		                        <div class='form-group'>
		                          ...
		                          <div class='col-sm-4 controls'>
			                            <input class="form-control" id="form_khxx_jhdate"   style="cursor:pointer;" info="fromInfo" name="form_khxx_jhdate" type="text" placeholder='交货日期' 	/>
		                          </div>
		                        </div>
		                        <div class='form-group'>
 		                        ...
 		                        <div class='form-group'>
		                          ...
		                          <div class='col-sm-4 controls'>
		                            <input class='form-control'  id='form_khxx_planendtime'   style="cursor:pointer;" info="fromInfo" name='form_khxx_planendtime' placeholder='计划结束时间' type='text'>
		                          </div>
		                        </div>
 		                        <div class='form-group'>
		                          <label class='control-label col-sm-3' for='form_khxx_realstarttime'>实际开始时间</label>
		                          <div class='col-sm-4 controls'>
		                            <input class='form-control'  id='form_khxx_realstarttime'    style="cursor:pointer;" info="fromInfo" name='form_khxx_realstarttime' placeholder='实际开始时间' type='text'>
		                          </div>
		                        </div>
 		                        <div class='form-group'>
		                          <label class='control-label col-sm-3' for='form_khxx_realendtime'>实际结束时间</label>
		                          <div class='col-sm-4 controls'>
		                            <input class='form-control'  id='form_khxx_realendtime'   style="cursor:pointer;" info="fromInfo" name='form_khxx_realendtime' placeholder='实际结束时间' type='text'>
		                          </div>
		                        </div>	
 		                        <div class='form-group'>
