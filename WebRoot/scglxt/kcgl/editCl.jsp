	                      ...
	                      <form id="form_bomInfo" class='form form-horizontal ' method="post" style='margin-bottom: 0;'>
							  <div class='form-group'>
								  <input style="display:none;" id='form_cl_id' info="fromInfo" name='id'
										  type='text'>
								  <label class='control-label col-sm-3 col-sm-3' for='form_cl_clmc'>材料名称</label>
							  ...
							  <div class='form-group'>
								  <label class='control-label col-sm-3 col-sm-3' for='form_cl_clcz'>材料材质</label>
								  <div class='col-sm-4 controls'>
							  ...
							  <div class='form-group'>
								  <label class='control-label col-sm-3 col-sm-3' for='form_cl_ghs'>供货商</label>
								  <div class='col-sm-4 controls'>
							  ...
							  <div class='form-group'>
								  <label class='control-label col-sm-3 col-sm-3' for='form_cl_mi'>密度</label>
								  <div class='col-sm-4 controls'>
							  ...
							  <div class='form-group'>
								  <label class='control-label col-sm-3 col-sm-3' for='form_cl_clxz'>材料性质</label>
								  <div class='col-sm-4 controls'>
							  ...
							  <div class='form-group'>
								  <label class='control-label col-sm-3 col-sm-3' for='form_cl_cd'>长度</label>
								  <div class='col-sm-4 controls'>
