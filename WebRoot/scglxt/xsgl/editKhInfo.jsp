                ...
                <form id="form_khxx" class='form form-horizontal ' method="post" style='margin-bottom: 0;'>
                    <div class='form-group'>
                        ...
                        <div class='col-sm-4 controls'>
                            ...
                            <input class='form-control' id='form_khxx_mc' name='form_khxx_mc' placeholder='客户名称'
                                   type='text'>
                        </div>
                    </div>
<<<<<<< HEAD
				...
				<div class="box-content box-no-padding">
	                      <form id="form_khxx" class='form form-horizontal ' method="post" style='margin-bottom: 0;'>
		                        <div class='form-group'>
		                          ...
		                          <div class='col-sm-4 controls'>
		                          <!-- data-rule-minlength='1' -->
		                            <input class='form-control' id='form_khxx_mc' name='form_khxx_mc'  placeholder='客户名称' type='text'>
		                          </div>
		                        </div>
		                        <div class='form-group'>
...
<!-- 		                            <input class="form-control" id="form_khxx_dw" name="form_khxx_dw" type="text" placeholder='客户单位'  onclick="showMenu('unitSel','unitTreeContent');" /> -->
			                            <input class="form-control" id="form_khxx_dw" name="form_khxx_dw" type="text" placeholder='客户单位' 	/>
			                          <!--  单位树-->
...
<!-- 									</div> -->
		                        ...
		                        <div class='form-group'>
		                          ...
		                          <div class='col-sm-4 controls'>
		                            <input class='form-control'  id='form_khxx_dz' name='form_khxx_dz' placeholder='客户地址' type='text'>
		                          </div>
		                        </div>
 		                        <div class='form-group'>
		                          <label class='control-label col-sm-3' for='form_khxx_gx'>合作关系</label>
		                          <div class='col-sm-4 controls'>
		                            <input class='form-control'  id='form_khxx_gx' name='form_khxx_gx' placeholder='合作关系' type='text'>
		                          </div>
		                        </div>
 		                        <div class='form-group'>
...
<!-- 				                         <div class="datepicker input-group"> -->
				                          <input class="form-control"     readonly style="cursor:pointer;" name="form_khxx_starttime" placeholder="开始合作时间" type="text" id="form_khxx_starttime">
<!-- 				                          <span class="input-group-addon"> -->
<!-- 				                            <span data-date-icon="icon-calendar" data-time-icon="icon-time" class="icon-calendar"></span> -->
<!-- 				                          </span> -->
<!-- 				                        </div> -->
<!-- 		                            <input class='form-control'  id='form_khxx_starttime' name='form_khxx_starttime' placeholder='开始合作时间' type='text'> -->
		                          </div>
		                        </div>
  		                        <div class='form-group'>
		                          <label class='control-label col-sm-3' for='form_khxx_remark'>备注</label>
		                          <div class='col-sm-4 controls'>
		                            <input class='form-control'  id='form_khxx_remark' name='form_khxx_remark' placeholder='备注' type='text'>
		                          </div>
		                        </div>
...
>>>>>>> 1439fa425b2312bc7569ef2491d642b2ee463e04
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-sm-4 controls'>
                            <!-- 				                         <div class="datepicker input-group"> -->
                            <input class="form-control" readonly style="cursor:pointer;" name="form_khxx_starttime"
