...
<html>
<head>
    <link href="${pageContext.request.contextPath}/stylesheets/light-theme.css" media="all"
          id="color-settings-body-color" rel="stylesheet" type="text/css"/>
    <link href="${pageContext.request.contextPath}/stylesheets/theme-colors.css" media="all"
          id="color-settings-body-color" rel="stylesheet" type="text/css"/>
    <link href="${pageContext.request.contextPath}/js/plugin/bootstrap/css/bootstrap.css" media="all" rel="stylesheet"
          type="text/css"/>
    <!-- bootstrap 表格插件样式 -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/stylesheets/plugins/datatables/jquery.dataTables.css"
          type="text/css"></link>
    <!-- bootstrap 时间插件样式 -->
    <link href="${pageContext.request.contextPath}/js/plugin/bootstrap_datetimepicker/css/bootstrap-datetimepicker.min.css"
          media="all" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/js/plugin/bootstrap-datepicker/css/datepicker.css" type="text/css"></link>
    <!-- fullcalendar插件样式 -->
    <link href="${pageContext.request.contextPath}/stylesheets/plugins/fullcalendar/fullcalendar.css" media="all"
...
=======
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/js/plugin/datatables/jquery.dataTables.js"></script>
    <!--   	<script type="text/javascript" src="${pageContext.request.contextPath}/js/plugin/datatables/dataTables.fixedColumns.js"></script> -->
    <!--   	<script type="text/javascript" src="${pageContext.request.contextPath}/js/plugin/datatables/dataTables.overrides.js"></script> -->
    <script src="${pageContext.request.contextPath}/js/plugin/bootstrap-datepicker/js/bootstrap-datepicker.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/plugin/bootstrap_datetimepicker/js/bootstrap-datetimepicker.min.js"
            type="text/javascript"></script>
    <%--<script src="${pageContext.request.contextPath}/js/plugin/bootstrap-datepicker/js/locales/bootstrap-datepicker.zh-CN.js" type="text/javascript"></script>--%>
    <script src="${pageContext.request.contextPath}/js/plugin/validate/jquery.validate.min.js"
            type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/plugin/validate/additional-methods.js"
            type="text/javascript"></script>
>>>>>>> 1439fa425b2312bc7569ef2491d642b2ee463e04
    <!-- 控制主页面左侧及头部导航、控制收缩空间 -->
